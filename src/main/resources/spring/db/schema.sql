...
CREATE TABLE `t_activity` (
  ...
  `activity_name` varchar(10) NOT NULL DEFAULT '' COMMENT '活动名称',
...
CREATE TABLE `t_food` (
  ...
  `item_name` varchar(32)  NOT NULL DEFAULT '' COMMENT '菜名',
  `item_title` varchar(100) NOT NULL DEFAULT '' COMMENT '菜品说明',
  `picture` varchar(255) NOT NULL DEFAULT '' COMMENT '菜品图片，多个以;分割',
  `count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '库存',
  `rank` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '星级1-5',
...
CREATE TABLE `t_order` (
  ...
  `item_ids` varchar(255)  NOT NULL DEFAULT '' COMMENT '所有商品ID，用;分割',
  ...
  `pay_type` varchar(10) NOT NULL COMMENT '支付方式，支付宝，微信，银行卡',
  `comments` varchar(255) NOT NULL COMMENT '备注信息',
...
CREATE TABLE `t_shop` (
  ...
  `shop_name` varchar(32)  NOT NULL DEFAULT '' COMMENT '商家名字',
  `title` text NOT NULL COMMENT '商家简介',
  ...
  `address` varchar(50)  NOT NULL DEFAULT '' COMMENT '商家地址',
  ...
  `main_picture` varchar(100)  NOT NULL DEFAULT '' COMMENT '商家图',
  ...
  PRIMARY KEY (`id`)
); --ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='店铺表';
...
CREATE TABLE `t_user` (
  ...
  `user_icon` varchar(100) NOT NULL COMMENT '用户头像',
